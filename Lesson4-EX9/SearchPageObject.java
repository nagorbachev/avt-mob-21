...
private static String getResultSearchElement(String substring)
{
    ...
    {
        return SEARCH_BY_TITLE_AND_DESCRIPTION.replace("{TITLE_OR_DESCRIPTION}", title_or_description);
    }
...
public void waitForSearchResult(String substring)
{
    ...
    {
        this.assertElementNotPresent(By.id(SEARCH_RESULT_ELEMENT), "We supposed not to find any results ");
    }
    ...
    public void waitForElementByTitleAndDescription(String title, String description)
    {
        ...
        this.waitForElementPresent(By.xpath(title), "Cannot find article title", 10);
