...
public class Ex6 {
    ...
    public void Ex6test() {
        ...
        assertElementPresent(
                "org.wikipedia:id/view_page_subtitle_text"
        );
    ...
    private void assertElementPresent(String recourceId) {

        recourceId = "//*[@resource-id='" + recourceId + "']";
        ...
        Assert.assertNotEquals(title.getText().length(), 0);
